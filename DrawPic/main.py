...
def drawSalesAndScoreOfArtist():
    ...
    bar = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="2000年-2019年音乐专辑销量前50的音乐作家专辑总销量", pos_left="center"),
            legend_opts=opts.LegendOpts(pos_top="30px"),
...
def drawReleaseNumAndSalesOfGenre():
    ...
    bar = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="2000年-2019年不同类型音乐专辑发行量与销量", pos_left="center"),
            legend_opts=opts.LegendOpts(pos_top="30px"),
